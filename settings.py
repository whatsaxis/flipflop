...
RECIPES_PATH = os.path.join(ROOT_DIR, 'items')
...
# REGENERATE_CACHE = ()  # TODO Change back for actual usage
...
# Sell tax percentage
BZ_FLIPPER_LEVEL = 1  # (assuming you have the free level of the Bazaar Flipper perk from the community centre)
TAX_PERCENTAGE = 1.25 - 0.125 * BZ_FLIPPER_LEVEL
